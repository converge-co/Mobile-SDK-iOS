    ...
    if(superSize.width*_height!=superSize.height*_width){
        if(superSize.width*_height < superSize.height*_width){
            ...
            dispatch_async(dispatch_get_main_queue(), ^{
                ...
                [strongLocalSelf setFrame:CGRectMake(0, (superSize.height-superSize.width*strongLocalSelf->_height/strongLocalSelf->_width)*0.5, superSize.width, superSize.width*strongLocalSelf->_height/strongLocalSelf->_width)];
            });
        }
        else{
//            dispatch_async(dispatch_get_main_queue(), ^{
